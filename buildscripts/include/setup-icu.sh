...
cd icu-host-build
if [ -r release-74-1.zip ]; then
    ICU_SOURCE_DIR=./icu-release-74-1/icu4c/source
else
    wget https://github.com/unicode-org/icu/archive/refs/tags/release-74-1.zip
    unzip release-74-1.zip
    ICU_SOURCE_DIR=./icu-release-74-1/icu4c/source
